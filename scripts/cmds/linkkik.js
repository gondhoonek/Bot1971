...
module.exports = {
    ...
    onChat: async function ({ api, event }) {
        ...
        if (msg.includes("http://") || msg.includes("https://") || msg.includes("www.")) {
            ...
            const notice = 
`⚠️ সতর্কবার্তা! ⚠️
 এই গ্রুপে লিংক দেওয়া সম্পূর্ণ নিষেধ 

➡️ তাই আপনাকে গ্রুপ থেকে রিমুভ করা হয়েছে ।  
অনুগ্রহ করে ভবিষ্যতে নিয়ম মেনে চলুন।
এসব নিয়ম মানতে পারলে অবশ্যই এডমিনের সাথে যোগাযোগ করবেন
কারণ ইসলাম মানুষকে ভালো হওয়ার সুযোগ করে দেয়`;
