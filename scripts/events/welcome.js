...
module.exports = {
        ...
        langs: {
                ...
                en: {
                        ...
                        session3: "🌆 𝐀𝐟𝐭𝐞𝐫𝐧𝐨𝐨𝐧",
                        session4: "🌙 𝐄𝐯𝐞𝐧𝐢𝐧𝐠",
                        welcomeMessage: "   ✰→ আসসালামু আলাইকুম ←✰\n\n আমি একটি ইসলামিক রোবট\n আমাকে ইসলামিক কাজে ব্যবহার করার জন্য ধন্যবাদ\n\nআসুন সবাই একসাথে ইসলাম প্রচার করি\n\n•┄┅═══❁আত-তাক্বওয়া ফাউন্ডেশন❁═══┅┄•",
                        multiple1: "🔹 𝖸𝗈𝗎",
                        multiple2: "🔹 𝖸𝗈𝗎 𝖦𝗎𝗒𝗌",
                        defaultWelcomeMessage: "🎉 『 𝗔𝗦𝗦𝗔𝗟𝗔𝗠𝗨 𝗔𝗟𝗔𝗜𝗞𝗨𝗠 』 🎉\n\n প্রিয় সহযোদ্ধা\n {userName}!\n\n আপনাকে\n 『 {boxName} 』\n এ স্বাগতম 🌸🌸\n\n আসুন সবাই মিলে ইসলাম প্রচার করি ইসলামকে বিশ্বের মাঝে ছড়িয়ে দি😻\n\n👤 আপনাকে যে অ্যাড করেছে: {adderName} \n\n ফাউন্ডেশন এর নিয়ম জানতে লিখুন👉𝗥𝘂𝗹𝗲𝘀👈\n ফাউন্ডেশন এর বিভিন্ন তথ্য সম্পর্কে জানতে লিখন👉𝗕𝗼𝘁👈\n\n ফাউন্ডেশন এর সকল নিয়ম মেনে চলার জন্য বিশেষভাবে অনুরোধ করা হলো\n               অনুরোধেঃ\n       আত-তাক্বওয়া ফাউন্ডেশন"
                }
        },
